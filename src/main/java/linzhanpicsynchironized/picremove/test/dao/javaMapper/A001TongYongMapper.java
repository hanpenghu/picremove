package linzhanpicsynchironized.picremove.test.dao.javaMapper;
...
public interface A001TongYongMapper {
    ...
    @Select({"select top 1 'suoLueTuAndFuJian/'+LocalFileName+';' from  lzproductimage where FKID = #{thumbnailID}"})
